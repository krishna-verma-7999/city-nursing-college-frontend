...
import { Caste, useCreateFeesMutation, useGetCoursesQuery } from "@/store/api";
...
const Page = () => {
  ...
  const { data: courses } = useGetCoursesQuery({ status: "PENDING" });
  ...
  return (
    <section className="py-5 px-2">
      <h1 className="font-bold text-xl">Create Fees Structure</h1>
      <form onSubmit={submitHandler} className="flex flex-col">
        ...
        <Button
          ...
          loadingTitle="Structure Creating..."
          className="self-end !w-fit"
          isDisable={isFeesCreating}
          isLoading={isLoading || isFeesCreating}
        />
      </form>
    </section>
  );
